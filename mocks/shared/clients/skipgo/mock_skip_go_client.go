...
// Balance provides a mock function with given fields: ctx, request
func (_m *MockSkipGoClient) Balance(ctx context.Context, request *skipgo.BalancesRequest) (*skipgo.BalancesResponse, error) {
	...
	var r0 *skipgo.BalancesResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *skipgo.BalancesRequest) (*skipgo.BalancesResponse, error)); ok {
		return rf(ctx, request)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *skipgo.BalancesRequest) *skipgo.BalancesResponse); ok {
		r0 = rf(ctx, request)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*skipgo.BalancesResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *skipgo.BalancesRequest) error); ok {
		r1 = rf(ctx, request)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *MockSkipGoClient_Expecter) Balance(ctx interface{}, request interface{}) *MockSkipGoClient_Balance_Call {
	return &MockSkipGoClient_Balance_Call{Call: _e.mock.On("Balance", ctx, request)}
}

func (_c *MockSkipGoClient_Balance_Call) Run(run func(ctx context.Context, request *skipgo.BalancesRequest)) *MockSkipGoClient_Balance_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*skipgo.BalancesRequest))
	})
	return _c
}

func (_c *MockSkipGoClient_Balance_Call) Return(_a0 *skipgo.BalancesResponse, _a1 error) *MockSkipGoClient_Balance_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSkipGoClient_Balance_Call) RunAndReturn(run func(context.Context, *skipgo.BalancesRequest) (*skipgo.BalancesResponse, error)) *MockSkipGoClient_Balance_Call {
	_c.Call.Return(run)
	return _c
}
